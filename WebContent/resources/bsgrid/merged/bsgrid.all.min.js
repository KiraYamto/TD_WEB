...
(function ($) {
    $.fn.bsgrid = {
        ...
        init: function (gridId, settings) {
            ...
            var gridObj = {
                ...
                getSelectedRowData:function(){
                	...
                	return gridObj.getRowRecord(gridObj.getSelectedRow(options));
                },
        ...
        getPageCondition: function (curPage, options) {            
            if(options.otherParames){
            	condition=options.otherParames;
            	condition[options.settings.requestParamsName.pageSize]= options.settings.pageSize ;
                condition[options.settings.requestParamsName.curPage]=curPage;
                condition[options.settings.requestParamsName.sortName]=options.sortName;
                condition[options.settings.requestParamsName.sortOrder]=options.sortOrder;
                return condition;
            }else{
