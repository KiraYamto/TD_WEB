define([
	'text!modules/nms/alarm/templates/alarmMap.html',
...
/*		afterRender:function(){
		...
		testBtn:function() {
			...
			//var axis = {'上海':[121.15 + Math.random()*5,31.89 + Math.random()*5]};
			$("#nmsAlarmMapChart").height($("#nmsAlarmMapChart").height());
			$("#nmsAlarmMapChart").width($("#nmsAlarmMapChart").width()-30);
			//currentObj.initEcharts(null, null);
			var myChart = echarts.getInstanceByDom(document.getElementById('nmsAlarmMapChart'));
			myChart.resize();
		},
		
		
		initEcharts:function(mydata, myaxis) {
			var myChart = echarts.init(document.getElementById('nmsAlarmMapChart'));
			var data8 = [
	                    {name:'上海',value:100},
	                    {name:'北京',value:100},
	                    {name:'成都',value:100},
			...
			var geoCoordMap = {
	          ...
	          var color = ['rgb(2,251,228)', '#ffa022', '#46bee9'];
	          var series = [];
...
/*	            	    show:false,
				        formatter: function (obj) {
				        	...
				        	var objType = obj.seriesType;
				        	if (objType == "lines")return;
				            return obj.name;
				        }*/
	              },
	              geo: {
