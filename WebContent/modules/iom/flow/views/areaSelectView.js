define([
	'text!modules/iom/flow/templates/areaSelectView.html'+codeVerP,
	'i18n!modules/iom/flow/i18n/tacheManage.i18n',
	'modules/common/cloud-utils',
	'css!modules/iom/flow/styles/tacheManage.css'+codeVerP
], function(areaSelectViewTpl, i18ntacheManage,utils,css) {
	return fish.View.extend({
		order_task_grid_last_select_id:-1,
		template: fish.compile(areaSelectViewTpl),
		i18nData: fish.extend({}, i18ntacheManage),
		events: {
		...
		_render: function() {
			...
			utils.ajax('cloudIomServiceForWeb', 'getEventCatalogWithEvent').done(
					function(ret) {
						...
						$("#iom-eventSelect-eventCatalog").tree(options); 
					});
