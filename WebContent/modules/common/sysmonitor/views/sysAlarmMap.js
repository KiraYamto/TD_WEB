define([
	'text!modules/common/sysmonitor/templates/sysAlarmMap.html',
	...
	return fish.View.extend({
		...
		resize:function(){
			if(this.myChart){
				...
				$("#sysAlarmMapChart").height(height);
				$("#sysAlarmMapChart").width(width);
				this.myChart.resize();
			}
		},
		//这里用来进行dom操作
		...
		initEcharts:function(mydata) {
			...
			var geoCoordMap = {
	          ...
	          var color = ['rgb(5,252,230)', '#ffa022', '#46bee9'];
	          var series = [];
