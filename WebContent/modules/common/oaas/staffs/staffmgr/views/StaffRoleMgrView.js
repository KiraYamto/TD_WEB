define([
	'text!modules/common/oaas/staffs/staffmgr/templates/StaffRoleMgrView.html',
	...
	return fish.View.extend({
		...
		events: {
			"click .list-group-item":"chooseRole",
			"click .list-group-item .close":"removeRole",
			"click #com-staffmgr-staffrole-addrole":"addRole",
			"click #com-staffmgr-staffrole-save":"saveRole"
		},
		_render: function() {
			...
			var options = {
				...
				this.$tree = this.$("#com-staffmgr-staffrole-roletree").tree(options);
