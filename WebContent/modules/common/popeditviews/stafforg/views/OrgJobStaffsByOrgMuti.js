define([ 'text!modules/common/popeditviews/stafforg/templates/OrgJobStaffsByOrgViewMuti.html',
	...
	return fish.View.extend({
		...
		chooseStaff : function(e) {
			...
			$.each(nodes, function(i, n) {
				...
				if(n.type==0){
					staffId.push(n.orgId);
				}
				staffId.push(n.id);
				type.push(n.type);
			});
			var result = {id:staffId, text:staffName,type:type};
			console.log(result);
			if(popup){
				popup.close(result);
			}else{
